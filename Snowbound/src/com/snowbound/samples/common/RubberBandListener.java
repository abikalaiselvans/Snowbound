...
/**
 * This class implements the "Zoom Rubber Band" Dragging and Drawing methods.
 */
public class RubberBandListener
    implements MouseListener, MouseMotionListener
{
    Rectangle selrect;
    AbstractImagePanel imagePanel;

    public RubberBandListener(AbstractImagePanel panel)
    {
        imagePanel = panel;
    }
    ...
    {
        snbd_draw_pen();
        imagePanel.zoomRubberBand(selrect);
        return;
    }
