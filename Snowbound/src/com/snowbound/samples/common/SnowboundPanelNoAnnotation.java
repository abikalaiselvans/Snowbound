 ...
 * This class...
 */
public class SnowboundPanelNoAnnotation extends AbstractImagePanel
{
    ...
    private void internalPaint(Graphics g)
    {
        if (Simage != null)
        {
            ...
            g.fillRect(0, 0, dimension.width, dimension.height);//draw rectangle
     ...
     * Default constructor
     */
    public SnowboundPanelNoAnnotation()
    {
        super();
    ...
    class snbdMouseMotionAdapter extends MouseMotionAdapter
    {
        ...
        public void mouseMoved(MouseEvent e)
        {
            ...
            if (magActive == true)
            {
                ...
                magXpos = pt.x - 50;
                magYpos = pt.y - 50;
                Simage.map_wnd_to_image(magPanel.getParent(), pt);
